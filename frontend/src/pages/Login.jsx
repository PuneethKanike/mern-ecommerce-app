...
const Login = () => {
  ...
  return (
    <form onSubmit={onSubmitHandler} className="flex flex-col items-center w-[90%] sm:max-w-96 m-auto mt-14 gap-4 text-gray-800">
        ...
        <button className="bg-black text-white px-8 font-light py-2 w-full mt-4 active:bg-gray-700 hover:bg-gray-800 hover:shadow-lg hover:scale-105 transition-all duration-300 ease-in-out transform">
